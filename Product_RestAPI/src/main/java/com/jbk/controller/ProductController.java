...
public class ProductController {
	...
	@GetMapping("/get-product-with-supplier-category/{id}")
	public Product_Supplier_Category getProductWithSC(@PathVariable long id) {
		
		Product_Supplier_Category productWithSC = service.getProductWithSC(id);
